...
from src.utils_asag_inference import *
from src.utils_process_pdf import Pil2cv_converter, Pdf2Image , computer_vision_scanned_version_file_ide, computer_vision_soft_version_file_ide
from src.utils_trocr_inference import *
...
ps, Httr_model, device, processor = initialize_model(
    SiameseModel_path=r"src\models\siamese_model.pth",
    main_model_path=r"src\models\TrOCR-finetuned-iamcvl\TrOCR-finetuned.pt",
)
...
def predict():
 ...
 # Process the first uploaded pdf 
    ...
    studentanswerpdf_page_parts = computer_vision_soft_version_file_ide(modelanswerpdf_pages)
